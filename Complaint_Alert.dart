...
class ComplaintAlertDialog extends StatefulWidget {
  ...
  createState() => _ComplaintAlertDialogState();
}

class _ComplaintAlertDialogState extends State<ComplaintAlertDialog> {
  Map<int, AssetImage> _typeAsset = {
   ComplaintAlertType.ERROR: AssetImage("packages/rich_alert/assets/error.png"),
    ComplaintAlertType.SUCCESS: AssetImage("packages/rich_alert/assets/success.png"),
    ComplaintAlertType.WARNING: AssetImage("packages/rich_alert/assets/warning.png"),
  };

  Map<int, Color> _typeColor = {
    ComplaintAlertType.ERROR: Colors.red,
    ComplaintAlertType.SUCCESS: Colors.green,
    ComplaintAlertType.WARNING: Colors.blue,
  };
...
Text alertSubtitle(String? subtitle) {
  return Text(
    subtitle!,
    style: TextStyle(
      fontSize: 18,
