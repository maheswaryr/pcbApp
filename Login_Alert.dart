...
class LoginAlertDialog extends StatefulWidget {
  ...
  createState() => _LoginAlertDialogState();
}

class _LoginAlertDialogState extends State<LoginAlertDialog> {
  Map<int, AssetImage> _typeAsset = {
    LoginAlertType.ERROR: AssetImage("packages/rich_alert/assets/error.png"),
    LoginAlertType.SUCCESS: AssetImage("packages/rich_alert/assets/success.png"),
    LoginAlertType.WARNING: AssetImage("packages/rich_alert/assets/warning.png"),
  };

  Map<int, Color> _typeColor = {
    LoginAlertType.ERROR: Colors.red,
    LoginAlertType.SUCCESS: Colors.green,
    LoginAlertType.WARNING: Colors.blue,
  };
