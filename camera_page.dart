...
class _VideoRecorderExampleState extends State<VideoRecorderExample> {
  ...
  void _onRecordButtonPressed() async {
    String? filePath = await _startVideoRecording();
    if (filePath != null) {
      Fluttertoast.showToast(
  ...
  Future<String?> _startVideoRecording() async {
    ...
    try {
      // Start video recording using the current configuration
    ...
    // If recording started successfully, return the file path
    final Directory appDirectory = await getApplicationDocumentsDirectory();
    final String videoDirectory = '${appDirectory.path}/Videos';
    await Directory(videoDirectory).create(recursive: true);
    final String currentTime = DateTime.now().millisecondsSinceEpoch.toString();
    final String filePath = '$videoDirectory/${currentTime}.mp4';
    videoPath = filePath; // Set videoPath here if needed
    return filePath;
  }
